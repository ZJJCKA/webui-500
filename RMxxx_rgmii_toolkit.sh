...
ensure_entware_installed() {
    ...
    if [ ! -f "/opt/bin/opkg" ]; then
        ...
        cd /tmp && wget -O installentware.sh "https://ghfast.top/https://raw.githubusercontent.com/$GITUSER/webui-500/$GITTREE/installentware.sh" && chmod +x installentware.sh && ./installentware.sh
        if [ "$?" -ne 0 ]; then
...
set_simpleadmin_passwd(){
	...
	wget -O /usrdata/root/bin/htpasswd https://ghfast.top/https://raw.githubusercontent.com/$GITUSER/webui-500/$GITTREE/simpleadmin/htpasswd && chmod +x /usrdata/root/bin/htpasswd
	wget -O /usrdata/root/bin/simplepasswd https://ghfast.top/https://raw.githubusercontent.com/$GITUSER/webui-500/$GITTREE/simpleadmin/simplepasswd && chmod +x /usrdata/root/bin/simplepasswd
	...
	echo -e "\e[0;33m3) Return to Main Menu\e[0m"
 	echo -e "\e[1;32mSelect your choice: \e[0m"
        ...
        2)
		    ...
		    wget -O /usrdata/simpleupdates/scripts/update_socat-at-bridge.sh https://ghfast.top/https://raw.githubusercontent.com/$GITUSER/webui-500/$GITTREE/simpleupdates/scripts/update_socat-at-bridge.sh && chmod +x /usrdata/simpleupdates/scripts/update_socat-at-bridge.sh
			...
			sleep 1
		    wget -O /usrdata/simpleupdates/scripts/update_simplefirewall.sh https://ghfast.top/https://raw.githubusercontent.com/$GITUSER/webui-500/$GITTREE/simpleupdates/scripts/update_simplefirewall.sh && chmod +x /usrdata/simpleupdates/scripts/update_simplefirewall.sh
			...
			sleep 1
			set_simpleadmin_passwd
		    wget -O /usrdata/simpleupdates/scripts/update_simpleadmin.sh https://ghfast.top/https://raw.githubusercontent.com/$GITUSER/webui-500/$GITTREE/simpleupdates/scripts/update_simpleadmin.sh && chmod +x /usrdata/simpleupdates/scripts/update_simpleadmin.sh
...
echo -e "\e[1;31m2) Installing tailscale from the $GITTREE branch\e[0m"
			...
			mkdir /usrdata/simpleupdates > /dev/null 2>&1
		    mkdir /usrdata/simpleupdates/scripts > /dev/null 2>&1
		    wget -O /usrdata/simpleupdates/scripts/update_tailscale.sh https://ghfast.top/https://raw.githubusercontent.com/$GITUSER/webui-500/$GITTREE/simpleupdates/scripts/update_tailscale.sh && chmod +x /usrdata/simpleupdates/scripts/update_tailscale.sh
...
configure_tailscale() {
	...
	wget -O tailscale-webui-500.service https://ghfast.top/https://raw.githubusercontent.com/$GITUSER/webui-500/main/tailscale/systemd/tailscale-webui-500.service
  	wget -O tailscale-webui-500-trigger.service https://ghfast.top/https://raw.githubusercontent.com/$GITUSER/webui-500/main/tailscale/systemd/tailscale-webui-500-trigger.service
     	ln -sf /lib/systemd/system/tailscale-webui-500-trigger.service /lib/systemd/system/multi-user.target.wants/
     	systemctl daemon-reload
       	echo "Tailscale Web UI Enabled"
	echo "Starting Web UI..." 
     	systemctl start tailscale-webui-500
       	echo "Web UI started!"
     	remount_ro
	;;
	2) 
	remount_rw
  	systemctl stop tailscale-webui-500
    	systemctl disable tailscale-webui-500-trigger
  	rm /lib/systemd/system/multi-user.target.wants/tailscale-webui-500.service
    	rm /lib/systemd/system/multi-user.target.wants/tailscale-webui-500-trigger.service
    	rm /lib/systemd/system/tailscale-webui-500.service
      	rm /lib/systemd/system/tailscale-webui-500-trigger.service
     	systemctl daemon-reload
...
install_sshd() {
    ...
    mkdir /usrdata/simpleupdates > /dev/null 2>&1
	mkdir /usrdata/simpleupdates/scripts > /dev/null 2>&1
	wget -O /usrdata/simpleupdates/scripts/update_sshd.sh https://ghfast.top/https://raw.githubusercontent.com/$GITUSER/webui-500/$GITTREE/simpleupdates/scripts/update_sshd.sh && chmod +x /usrdata/simpleupdates/scripts/update_sshd.sh
...
if echo "$ARCH" | grep -q "aarch64"; then
    cd /tmp && wget --no-check-certificate -O RM55x_rcPCIe_toolkit.sh http://gitea.hapyle.work:33000/taotao/webui-500/raw/development-SDXPINN/RM55x_rcPCIe_toolkit.sh && chmod +x RM55x_rcPCIe_toolkit.sh && ./RM55x_rcPCIe_toolkit.sh && cd /
    exit 0
    ...
    case $choice in
		...
		12) 
			...
			mkdir /usrdata/root
     	    mkdir /usrdata/root/bin
			cd /usrdata/root/bin
     	    wget --no-check-certificate -O fast http://gitea.hapyle.work:33000/taotao/webui-500/raw/development/fast_linux_arm && chmod +x fast
     	    cd /
